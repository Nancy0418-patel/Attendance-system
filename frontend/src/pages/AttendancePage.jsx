  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const studentProfileResponse = await fetch(`http://localhost:5000/api/students/profile`, {
          headers: {
        ...
        const timetableResponse = await fetch(`http://localhost:5000/api/timetable/${studentClassId}/${dayOfWeek}`, {
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json',
          },
        ...
        const attendanceRecordsResponse = await fetch(`http://localhost:5000/api/attendance/${studentId}`, {
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json',
          },
